...
class action_cart extends library{
  ...
  /*-------------------------------------------------*/
  public function addCart($total_price, $session_id, $name_buyer, $email_buyer, $phone_buyer, $address_buyer, $note_buyer, $city1, $district1, $payment, $name, $phone, $address, $city2, $district2, $ship, $sale){

    global $conn_vn;
    $date_cart = $this->sw_get_current_weekday();
    $sql = "INSERT into cart (session_id, total_price, date_cart, name_buyer, mail_buyer, phone_buyer, address_buyer, note_buyer, city1, district1, payment, name, phone, address, city2, district2, ship, sale) values ('".$session_id."',"."'".$total_price."',"."'".$date_cart."',"."'".$name_buyer."',"."'".$email_buyer."',"."'".$phone_buyer."',"."'".$address_buyer."',"."'".$note_buyer."',"."'".$city1."',"."'".$district1."',"."'".$payment."',"."'".$name."',"."'".$phone."',"."'".$address."',"."'".$city2."',"."'".$district2."',"."'".$ship."',"."'".$sale."')";
    $result = mysqli_query($conn_vn,$sql);  
  ...
  public function payment1 () {
      ...
      $district1 = isset($_POST['district']) ? $_POST['district'] : '';
      $payment = $_POST['PaymentMethodId'];
      ////////////
      $name = isset($_POST['name']) ? $_POST['name'] : '';
      $phone = isset($_POST['phone']) ? $_POST['phone'] : '';
      $address = isset($_POST['address']) ? $_POST['address'] : '';
      $city2 = isset($_POST['city2']) ? $_POST['city2'] : '';
      $district2 = isset($_POST['district2']) ? $_POST['district2'] : '';
      /////////////
      $ship = $_SESSION['cart_ship'];
      if (!isset($_SESSION['cart_sale'])) {
        $_SESSION['cart_sale'] = 0;
      }
      $sale = $_SESSION['cart_sale'];
      /////////////
      $totalPrice = 0;
      ...
      $session_id = session_id();    
      $id_cart = $this->addCart(0, $session_id, $name_buyer, $email_buyer, $phone_buyer, $address_buyer, $note_buyer, $city1, $district1, $payment, $name, $phone, $address, $city2, $district2, $ship, $sale);
      foreach ($rows as $row) {
          $this->addItemCart($row->id_product, $row->count, $row->price, $session_id, $row->color, $row->size, $row->id_color, $row->id_size, $id_cart);
          $totalPrice += $row->total;              
      }
