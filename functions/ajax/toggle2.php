                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="field__input-wrapper field__input-wrapper--select">
                                                                    ...
                                                                    <select class="field__input field__input--select form-control filter-dropdown select2-hidden-accessible" name="city" id="billingProvince" required="" data-error="Bạn chưa chọn tỉnh thành" bind-event-change="billingProviceChange('')" bind="BillingProvinceId" data-select2-id="billingProvince" tabindex="-1" aria-hidden="true">
                                                    ...
                                                    <div class="form-group" bind-show="requiresShipping">
                                                        <div class="checkbox-wrapper">
                                                            <div class="checkbox__input">
                                                                <input class="input-checkbox" type="checkbox" value="false" name="otherAddress" id="other_address" bind="otherAddress" bind-event-change="changeOtherAddress(this)" onclick="toggle1()" checked="">
                                                            </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div bind-show="!otherAddress" class="form-group">
                                                                <div
                                                                    ...
                                                                    <select
                                                                        class="field__input field__input--select form-control filter-dropdown select2-hidden-accessible"
                                                                        name="district2" id="billingDistrict"
                                                                        required=""
