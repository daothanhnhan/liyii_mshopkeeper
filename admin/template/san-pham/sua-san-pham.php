    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <p class="titleRightNCP"><a href="index.php?page=mau-san-pham&product_id=<?= $_GET['id'] ?>">Màu sản phẩm</a></p>
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP2 ckeditor1" id="editor0" name="product_des"><?php echo $row_showMain['lang_product_des'];?></textarea></p>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_favorite" <?= $row['product_favorite'] == 1 ? 'checked' : '' ?>>Sản phẩm nổi bật
