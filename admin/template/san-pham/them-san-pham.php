<?php 
    ...
    $product = $mshopkeeper->get_product($_GET['id_msk']);//var_dump($product);
...
<form action="" method="post" enctype="multipart/form-data" id="addProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="hidden" name="mshopkeeper_id" value="<?= $_GET['id_msk'] ?>">
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_favorite">Sản phẩm nổi bật
