<?php 
	...
	function code_sale () {
		...
		if (isset($_POST['add_sale'])) {
			...
			$sql = "INSERT INTO code_sale (code, `money`) VALUES ('$code', '$money')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một mã khuyến mãi.\');window.location.href="index.php?page=ma-khuyen-mai"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="code" required/>
            <p class="titleRightNCP">Chiết khấu VNĐ</p>
            <input type="text" class="txtNCP1" name="money" id="money" onkeyup="moneyf(this)" required/>
