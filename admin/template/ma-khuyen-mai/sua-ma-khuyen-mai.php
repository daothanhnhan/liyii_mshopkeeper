<?php 
	...
	function code_sale ($id) {
		...
		if (isset($_POST['add_sale'])) {
			...
			$sql = "UPDATE code_sale SET code = '$code', `money` = $money WHERE id = $id";
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="money" id="money" value="<?= number_format($info['money']) ?>" onkeyup="moneyf(this)" required/>
