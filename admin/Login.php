...
<div id="divWrapper">
    <div class="coverFormLogin">
        <form method="post" class="formLogin" id="formLogin">
            ...
            <img src="image/logoAdmin.jpg" alt="GoldBridge" class="logoLogin" /> 
            <div class="boxForm">
        ...
        <p class="endLogin">Công ty TNHH PHÁT TRIỂN THƯƠNG HIỆU CAFE LINK VIỆT NAM<br /><em style="text-decoration:underline;">Điện thoại:</em> <strong>0865.689.886</strong> - <em style="text-decoration:underline;">Hotline:</em> <strong>0337.86.78.79</strong><br /><em style="text-decoration:underline;">Website:</em> cafelink.org</p>
