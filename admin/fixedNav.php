    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=nhan-tin" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhận tin</a>
            </li>

            <li><a href="index.php?page=ma-khuyen-mai" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Mã khuyến mãi</a>
            </li>
