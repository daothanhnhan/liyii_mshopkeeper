...
// $tuan = $mshopkeeper->get_token();var_dump($tuan);die;
...
<?php 
  function dong_bo () {
    ...
    $mshopkeeper = new action_mshopkeeper();
        ...
        $product_all = $mshopkeeper->get_products_all();
        $product_all = json_encode($product_all);
        // var_dump($product_all);
        $sql = "UPDATE product_mshopkeeper SET data = ? WHERE id = 1";
        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case "san-pham-1":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/san-pham/san-pham-1.php");
                        break;
                    ...
                    ///////////// newsletter //////////////
                    case "nhan-tin":
                        include_once("template/nhan-tin/nhan-tin.php");
                        break;
                    /////////// mau san pham //////////////
                    case "mau-san-pham":
                        include_once("template/mau-san-pham/mau-san-pham.php");
                        break;
                    case "them-mau-san-pham":
                        include_once("template/mau-san-pham/them-mau-san-pham.php");
                        break;
                    case "sua-mau-san-pham":
                        include_once("template/mau-san-pham/sua-mau-san-pham.php");
                        break;
                    ///////////// Default /////////////////
                    default:
